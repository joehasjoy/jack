...
<div class="team-main">
    <div class="table-box">
        <el-tabs v-model="activeTenantSetting" @tab-click="changeConfig">
            <el-tab-pane label="代码仓库" name="code">
                <el-form ref="code_config" :model="code_config" label-width="120px" label-position="left">
                    <el-form-item label="仓库类型:" required>
                        <el-select v-model="code_config.repoType" placeholder="请选择类型" @change="ChangeRepoType" style="width: 387px">
                            <el-option v-for="item in repoTypes" :key="item.value" :label="item.label" :value="item.value" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="仓库地址:" required>
                        <el-input v-model="code_config.url" style="width: 387px"></el-input>
                    </el-form-item>
                    <el-form-item label="ssh密钥:" required>
                        <el-upload action="/" ref="upload" accept="" :before-upload="beforeUpload" :default-file-list="this.fileList">
                            <el-button icon="el-icon-upload" size="mini">上传</el-button>
                        </el-upload>
                    </el-form-item>
                    <el-form-item required>
                        <el-input type="textarea" rows="5" v-model="code_config.sshKeyFile"></el-input>
                        <div style="color: #999999; font-size: 10px">
                            提示: 需要租户将公钥添加到管理员账户下,建议绑定到机器人账户下
                        </div>
                    </el-form-item>

                    <el-form-item label="User:" required>
                        <el-input v-model="code_config.user" placeholder="oauth2" style="width: 387px"></el-input>
                    </el-form-item>

                    <el-form-item label="Token:" required>
                        <el-input v-model="code_config.token" type="password" placeholder="token" style="width: 387px"></el-input>
                    </el-form-item>

                    <el-form-item style="margin-top: 50px">
                        <el-button size="small" type="primary" @click="SaveConfig('code')">保 存</el-button>
                        <el-button size="small" @click="ResetConfig('code')">重 置</el-button>
                    </el-form-item>
                </el-form>
            </el-tab-pane>
            <el-tab-pane label="私服配置" name="neus">
                <el-form ref="form" :model="build_config" label-width="120px" label-position="left">
                    <el-form-item label="构建类型:" required>
                        <el-select style="width: 387px" v-model="build_config.buildType" value-key="buildType" placeholder="请选择类型" @change="ChangeBuildType">
                            <el-option v-for="item in buildTypes" :key="item.value" :label="item.label" :value="item.value" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="settings文件:" required>
                        <el-upload action="/" ref="upload" accept="" :before-upload="beforeUpload" :default-file-list="this.fileList">
                            <el-button icon="el-icon-upload" size="mini">上传</el-button>
                        </el-upload>
                    </el-form-item>
                    <el-form-item required>
                        <el-input type="textarea" rows="5" v-model="build_config.settingsFile"></el-input>
                    </el-form-item>
                    <el-form-item style="margin-top: 50px">
                        <el-button size="small" type="primary" @click="SaveConfig('neus')">保 存</el-button>
                        <el-button size="small" @click="ResetConfig('neus')">重 置</el-button>
                    </el-form-item>
                </el-form>
            </el-tab-pane>
            <el-tab-pane label="镜像仓库配置" name="image-repo">
                <el-form ref="form" :model="image_config" label-width="120px" label-position="left">
                    <el-form-item label="仓库地址:" required>
                        <el-input v-model="image_config.url" style="width: 387px"></el-input>
                    </el-form-item>
                    <el-form-item label="用户名:" required>
                        <el-input v-model="image_config.username" style="width: 387px"></el-input>
                    </el-form-item>

                    <el-form-item label="密码:" required>
                        <el-input v-model="image_config.password" style="width: 387px"></el-input>
                    </el-form-item>
                    <el-form-item label="确认密码:" required>
                        <el-input v-model="image_config.confirmPassword" style="width: 387px"></el-input>
                    </el-form-item>

                    <el-form-item style="margin-top: 50px">
                        <el-button size="small" type="primary" @click="SaveConfig('image-repo')">保 存</el-button>
                        <el-button size="small" @click="ResetConfig('image-repo')">重 置</el-button>
                    </el-form-item>
                </el-form>
            </el-tab-pane>
            <el-tab-pane label="新智云账号配置" name="account">
                <el-form ref="form" :model="account_config" label-width="138px" label-position="left">
                    <el-form-item label="新智云邮箱:" required>
                        <el-input v-model="account_config.cloudMail" style="width: 387px"></el-input>
                    </el-form-item>

                    <el-form-item label="AccessKeyId:" required>
                        <el-input v-model="account_config.cloudAccesskeyid" style="width: 387px"></el-input>
                    </el-form-item>

                    <el-form-item label="SecretAccessKey:" required>
                        <el-input type="textarea" rows="3" v-model="account_config.cloudSecretaccesskey" style="width: 387px"></el-input>
                    </el-form-item>

                    <el-form-item style="margin-top: 50px">
                        <el-button size="small" type="primary" @click="SaveConfig('account')">保 存</el-button>
                        <el-button tsize="small" @click="ResetConfig('account')">重 置</el-button>
                    </el-form-item>
                </el-form>
            </el-tab-pane>

            <el-tab-pane label="基础镜像" name="BaseImageComponent">
                <BaseImageComponent></BaseImageComponent>
            </el-tab-pane>
            <el-tab-pane label="人员黑名单" name="personnelBlacklist">
                <personnelBlacklist></personnelBlacklist>
            </el-tab-pane>
        </el-tabs>
    </div>
    ...
    <el-dialog :title="newTitle" :visible.sync="dialognewRowForm" :close-on-click-modal="false" width="998px">
        <el-form size="mini" label-width="120px" :model="newRow" ref="newRow" style="margin-left: auto; margin-right: auto">
            ...
            <el-form-item label>
                <el-button type="primary" plain="plain" @click="newPutRow(cluster_url, 'POST')" v-if="!newRow.id" :loading="action_loading">确 定</el-button>
                <el-button type="warning" plain="plain" @click="newPutRow(cluster_url, 'PUT')" v-if="newRow.id" :loading="action_loading">更 新</el-button>
    ...
    <!-- 新image Row -->
    <el-dialog :title="newTitle" :visible.sync="dialognewImageForm" :close-on-click-modal="false" width="998px">
        <el-form size="mini" label-width="120px" :model="newImage" ref="newImage" style="margin-left: auto; margin-right: auto">
            <el-form-item hidden>
            ...
            <el-form-item label="镜像地址" prop="image" :rules="[{ required: true, message: '请输入名称', trigger: 'blur' }]">
            ...
            <el-form-item label>
                <el-button type="primary" plain="plain" @click="ImagenewPutRow(image_url, 'POST')" v-if="!newImage.id" :loading="action_loading">确 定</el-button>
                <el-button type="warning" plain="plain" @click="ImagenewPutRow(image_url, 'PUT')" v-if="newImage.id" :loading="action_loading">更 新</el-button>
    ...
    <!-- 新BusinessDomain Row -->
    <el-dialog :title="newTitle" :visible.sync="dialogBusinessDomainForm" :close-on-click-modal="false" width="998px">
        <el-form size="mini" label-width="120px" :model="newBusinessDomain" ref="newBusinessDomain" style="margin-left: auto; margin-right: auto">
            <el-form-item hidden>
                <el-input v-model="newBusinessDomain.id" style="width: 240px"></el-input>
            </el-form-item>
            <el-form-item label="名称" prop="name" :rules="[{ required: true, message: '请输入名称', trigger: 'blur' }]">
                <el-input v-model="newBusinessDomain.name" style="width: 240px"></el-input>
            </el-form-item>
            ...
            <el-form-item label="上级域">
                <el-select v-model="newBusinessDomain.up_domain_id" clearable filterable placeholder="上级域">
                    <el-option :value="item.id" :label="item.name + '<' + item.code + '>'" v-for="(item, index) in business_domains" :key="index">
            ...
            <el-form-item label="描述">
                <el-input v-model="newBusinessDomain.description" type="textarea"></el-input>
            </el-form-item>
            <el-form-item label="创建NS">
                <el-checkbox-group v-model="create_ns">
                    <el-checkbox v-for="env in ['dev', 'test', 'uat', 'prod']" :label="env" :key="env">{{ env }}</el-checkbox>
                </el-checkbox-group>
            </el-form-item>
            ...
            <el-form-item label>
                <el-button type="primary" plain="plain" @click="BusinessDomainnewPutRow(team_url, 'POST')" v-if="!newBusinessDomain.id" :loading="action_loading">确 定</el-button>
                <el-button type="warning" plain="plain" @click="BusinessDomainnewPutRow(team_url, 'PUT')" v-if="newBusinessDomain.id" :loading="action_loading">更 新</el-button>
    ...
    <!-- 新Env Row -->
    <el-dialog :title="newTitle" :visible.sync="dialognewEnvForm" :close-on-click-modal="false" width="998px">
        <el-form size="mini" label-width="120px" :model="newEnv" ref="newEnv" style="margin-left: auto; margin-right: auto">
            <el-form-item hidden>
            ...
            <el-form-item label>
                <el-button type="primary" plain="plain" @click="EnvPutRow(env_url, 'POST')" v-if="!newEnv.id" :loading="action_loading">确 定</el-button>
                <el-button type="warning" plain="plain" @click="EnvPutRow(env_url, 'PUT')" v-if="newEnv.id" :loading="action_loading">更 新</el-button>
                <el-button @click="dialognewEnvForm = false">取 消</el-button>
            </el-form-item>
        </el-form>
    </el-dialog>

    <el-dialog title="结果" :visible.sync="ShowResultProject" :close-on-click-modal="false" width="998px">
        <div v-if="ResultProjectInit.harbor_ret.status !== 'default'">
            <div>
                <span style="font-weight: bold">Harbor 项目创建：</span>
                <span style="font-weight: bold; color: green" v-if="ResultProjectInit.harbor_ret.status === 'success'">{{ ResultProjectInit.harbor_ret.msg }}</span>
                <span style="font-weight: bold; color: red" v-else>{{
            ResultProjectInit.harbor_ret.msg
          }}</span>
            </div>
        </div>
        <div v-if="ResultProjectInit.create_ns_ret.status !== 'default'" style="margin-top: 10px">
            <div style="font-weight: bold">创建 Namespace：</div>
            <div v-for="(o, i) in ResultProjectInit.create_ns_ret.list" :key="i" class="text item">
                <span style="font-weight: bold; color: green" v-if="o.status === 'success'">创建命名空间 {{ o.namespace }}成功， 信息：{{ o.msg }}</span>
                <span style="font-weight: bold; color: red" v-else>创建命名空间{{ o.namespace }}失败， 信息：{{ o.msg }}</span>
            </div>
        </div>
        <div v-if="ResultProjectInit.ns_init_ret.status !== 'default'" style="margin-top: 10px">
            <div style="font-weight: bold">Namespace 初始化：</div>
            <div v-for="(o, i) in ResultProjectInit.ns_init_ret.list" :key="i" class="text item">
                <span>命名空间{{ o.namespace }}下，</span>
                <span>
                    创建 Image key
                    <span style="font-weight: bold; color: green" v-if="o.image === 'success'">成功。</span>
                    <span style="font-weight: bold; color: red" v-else>失败，{{ o.image }}</span>
                </span>
                <span>
                    创建 证书
                    <span style="font-weight: bold; color: green" v-if="o.cert === 'success'">成功。</span>
                    <span style="font-weight: bold; color: red" v-else>失败，{{ o.cert }}</span>
                </span>
            </div>
        </div>
    </el-dialog>
    ...
    <el-dialog title="修改负责人" :visible.sync="addRespPersonVisible" width="40%">
        <el-form ref="addRespPersonForm" :model="respPersonForm" :rules="addRespPersonFormRules" label-width="100px">
            <el-row>
                <el-col :span="24">
            ...
            <el-form-item>
                ...
                <el-button type="info" @click="closeRespPersonDialog">取 消</el-button>
            </el-form-item>
        </el-form>
    </el-dialog>

    <el-dialog title="团队成员" :visible.sync="addTeamMemberVisible" width="80%" :before-close="addTeamMemberClose">
        <el-form ref="addTeamMemberForm" :model="memberform" :rules="memberformRules">
            <el-row>
                <el-col :span="6">
                ...
                <el-col :span="3">
                    <el-button size="medium" type="primary" @click="addTeamMember()">加入应用组</el-button>
                </el-col>
            </el-row>
        </el-form>

        <span style="float: left; padding-top: 10px">已有成员</span><br /><br />
        <el-table ref="singleTable" :data="memberTableData" border tooltip-effect="dark" :header-cell-style="{ 'text-align': 'center' }">
        ...
        ></el-table-column> -->
            <el-table-column label="操作" align="center" width="100">
                <template slot-scope="scope">
                    <el-button @click="removeTeamMember(scope.row)" type="text" size="small">移除</el-button>
                </template>
            </el-table-column>
    ...
    <el-dialog title="空间权限" :visible.sync="setTeamClusterVisible">
            ...
            <el-row>
                <el-col :span="24">
                    <el-checkbox-group v-model="clusterNsCheckeds" style="">
                        <el-checkbox v-for="clusterNsItem in cluster.clusterNsList" :label="clusterNsItem.clusterNsId" :key="clusterNsItem.clusterNsId" :checked="clusterNsItem.clusterNsChecked" style="margin-left: 0px; float: left">
        ...
        <div style="text-align: center">
            ...
            <el-button type="info" @click="closeSetTeamClusterDialog">取 消</el-button>
        </div>
    </el-dialog>

    <!-- //更新名称与kubeconfig -->

    <el-dialog title="更新名称和kubeconfig" :visible.sync="nameAndKubeConfigDialogFormVisible" width="45%">
        <el-form ref="nameAndKubeConfigAddForm" :model="kubeconfigform" label-width="120px">
            <el-input v-model="kubeconfigform.id" type="hidden"></el-input>
            <el-row>
                <el-col>
                    <el-form-item label="集群名称:" required>
                        <el-input v-model="kubeconfigform.name" style="width: 495px"></el-input>
                    </el-form-item>
                    <el-form-item label="环境类型:" required>
                        <el-select v-model="kubeconfigform.envFlag" placeholder="请选择环境" style="width: 495px">
            ...
            <el-row>
                <el-form-item required>
                    ...
                    <el-input type="textarea" v-model="kubeconfigform.kubeConfig" id="tenantRemark" rows="6" style="width: 495px"></el-input>
                </el-form-item>
            </el-row>
            <el-form-item>
                <el-button type="primary" icon="el-icon-check" @click="UpdateK8sConfig()">保 存</el-button>
                <el-button type="danger" icon="el-icon-refresh" @click="ResetConfig('K8sConfig')">重 置</el-button>
            </el-form-item>
        </el-form>
    </el-dialog>

    <!-- //忽略namespace -->
    <el-dialog title="忽略namespace" :visible.sync="namespaceDialogFormVisible">
        <el-table :data="namespaceTableData" height="380">
            <el-table-column v-if="false" prop="id" label="隐藏id" width="180">
            </el-table-column>
            <el-table-column prop="name" label="命名空间" width="180">
            </el-table-column>
            <el-table-column label="是否忽略" width="180">
                <template slot-scope="scope">
                    <el-switch on-text="是" off-text="否" on-color="#5B7BFA" off-color="#dadde5" v-model="scope.row.status" @change="enableAndIgnoreNs(scope.$index, scope.row)">
                    </el-switch>
                </template>
            </el-table-column>
        ...
        <div style="margin-top: 15px; text-align: center">
            <el-button type="primary" @click="IgnoreNamespace">确 定</el-button>
            <el-button size="medium" type="info" @click="closeNamespace">取 消</el-button>
        </div>
    </el-dialog>

    <el-dialog title="创建namespace" :visible.sync="createNamespaceDialogFormVisible" width="45%">
        <el-form ref="createNameSpaceFormRef" :model="createNameSpaceForm" :rules="rules" label-width="120px">
            <el-input v-model="createNameSpaceForm.id" type="hidden"></el-input>
            <el-row>
                <el-col>
                    <el-form-item label="命名空间名称:" prop="namespaceName" required>
                        <el-input v-model="createNameSpaceForm.namespaceName" style="width: 200px"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <div style="color: red">
        ...
        <div slot="footer" class="dialog-footer" style="margin-top: 15px">
            <el-button size="medium" type="primary" @click="closeCreateNameSpace">取 消</el-button>
            <el-button type="primary" @click="confirmAddForm">确 定</el-button>
        </div>
    </el-dialog>

    <!-- //管理集群外访问方式 -->
    <el-dialog title="管理集群外访问方式" :visible.sync="visitTypeDialogFormVisible" width="40%">
        <el-form ref="vistTypeform" :model="formVistType" :rules="rules" label-width="120px">
            <el-input v-model="formVistType.id" type="hidden"></el-input>
            <el-row>
                <el-col>
                    <el-form-item label="集群访问方式:" prop="visitType" required>
                        <el-select v-model="formVistType.visitType" placeholder="请选择集群访问方式" @change="visitTypeSelectOptionChange($event)" style="width: 200px">
            ...
            <el-row v-if="visitType == 2">
                <el-col>
                    <el-form-item label="NodeIp1:" prop="nodeIp1" required>
                        <el-input v-model="formVistType.nodeIp1" style="width: 200px"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="visitType == 3">
                <el-col>
                    <el-form-item label="Ingress域名:" prop="ingressDs" required>
                        <el-input v-model="formVistType.ingressDs" style="width: 200px"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
        ...
        <div style="margin-top: 15px; text-align: center">
            <el-button type="primary" @click="saveFormVistType">确 定</el-button>
            <el-button size="medium" type="info" @click="closeFormVistType">取 消</el-button>
        </div>
    </el-dialog>

    <el-dialog :visible.sync="addClusterDialogFormVisible" title="新增集群信息">
        <el-steps :active="active" finish-status="success" simple>
            <el-step title="输入集群信息" icon="el-icon-edit"></el-step>
            <el-step title="选择空间" icon="el-icon-search"></el-step>
            <el-step title="接入完成" icon="el-icon-circle-check"></el-step>
        </el-steps>

        <template v-if="active == 0">
            <el-form ref="NewNameAndKubeConfigAddForm" :model="AddKubeconfigform" label-width="120px">
                <el-input v-model="AddKubeconfigform.id" type="hidden"></el-input>
                <el-row>
                    <el-col>
                        <el-form-item label="集群名称:" required>
                            <el-input v-model="AddKubeconfigform.name" style="width: 495px"></el-input>
                        </el-form-item>
                        <el-form-item label="环境类型:" required>
                            <el-select v-model="AddKubeconfigform.envFlag" placeholder="请选择环境" style="width: 495px">
                                <el-option v-for="item in envOptions" :key="item.value" :label="item.label" :value="item.value">
                                </el-option>
                            </el-select>
                        </el-form-item>
                ...
                <el-row>
                    <el-form-item required>
                        ...
                        <el-input type="textarea" v-model="AddKubeconfigform.kubeConfig" id="tenantRemark" rows="6" style="width: 495px"></el-input>
                    </el-form-item>
                </el-row>
            </el-form>
        </template>
        ...
        <div style="text-align: center; margin-top: 20px">
            <el-button v-if="(this.active > 0) & (this.active < 2)" size="medium" type="info" @click="prev">上一步</el-button>
            <el-button v-if="this.active < 2" size="medium" type="primary" @click="next">下一步</el-button>
            <el-button v-if="this.active == 2" size="medium" type="primary" @click="complete">完成</el-button>
        </div>
    </el-dialog>
</div>
</template>
...
import personnelBlacklist from "./components/personnelBlacklist";
export default {
    ...
    data() {
        ...
        return {
            ...
            rules: {
                ...
                kubeconfig: [{
                    required: true,
                    message: "kubeconfig不能为空",
                    trigger: "change"
                }, ],
                ingressDs: [{
                    required: false,
                    validator: validateIngressDS,
                    trigger: "change"
                }, ],
                nodeIp1: [{
                    required: true,
