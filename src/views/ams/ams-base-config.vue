<template>
  <div class="team-main">
    <el-tabs v-model="activeName" @tab-click="tabClick">
          ...
          >
            ...
            <el-form-item>
              <el-button
                ...
                >查询</el-button
              >
              <el-button type="info" icon="el-icon-plus" @click="AddNewCursor"
                >新增</el-button
              >
              <!-- <el-button
                  type="danger"
      ...
      <el-tab-pane label="租户管理" name="tenantSetting" class="panel-tab">
        <div class="table-box">
          <el-tabs v-model="activeTenantSetting" @tab-click="changeConfig">
              ...
              >
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="仓库地址:" required>
                      <el-input v-model="code_config.url"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item required>
                      ...
                      <el-input
                        type="textarea"
                        rows="5"
                        v-model="code_config.sshKeyFile"
                      ></el-input>
                      <div style="color: red">
                        提示:
                        需要租户将公钥添加到管理员账户下,建议绑定到机器人账户下
                      </div>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-form-item>
                  <el-button
                    type="primary"
                    icon="el-icon-check"
                    @click="SaveConfig('code')"
                    >保 存</el-button
                  >
                  <el-button
                    type="danger"
                    icon="el-icon-refresh"
                    @click="ResetConfig('code')"
                    >重 置</el-button
                  >
                </el-form-item>
              </el-form>
            ...
            <el-tab-pane label="私服配置" name="neus">
              <el-form ref="form" :model="build_config" label-width="120px">
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="构建类型:" required>
                      <el-select
                        v-model="build_config.buildType"
                        value-key="buildType"
                        placeholder="请选择类型"
                  ...
                  <el-col :span="24">
                    <el-form-item required>
                      ...
                      <el-input
                        type="textarea"
                        rows="5"
                        v-model="build_config.settingsFile"
                      ></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-form-item>
                  <el-button
                    type="primary"
                    icon="el-icon-check"
                    @click="SaveConfig('neus')"
                    >保 存</el-button
                  >
                  <el-button
                    type="danger"
                    icon="el-icon-refresh"
                    @click="ResetConfig('neus')"
                    >重 置</el-button
                  >
                </el-form-item>
              </el-form></el-tab-pane
            ...
            <el-tab-pane label="镜像仓库配置" name="image-repo">
              <el-form ref="form" :model="image_config" label-width="120px">
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item label="仓库地址:" required>
                      <el-input v-model="image_config.url"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="用户名:" required>
                      <el-input v-model="image_config.username"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item label="密码:" required>
                      <el-input v-model="image_config.password"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="确认密码:" required>
                      <el-input
                        v-model="image_config.confirmPassword"
                      ></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-form-item>
                  <el-button
                    type="primary"
                    icon="el-icon-check"
                    @click="SaveConfig('image-repo')"
                    >保 存</el-button
                  >
                  <el-button
                    type="danger"
                    icon="el-icon-refresh"
                    @click="ResetConfig('image-repo')"
                    >重 置</el-button
                  >
                </el-form-item>
              </el-form>
            ...
            <el-tab-pane label="新智云账号配置" name="account">
              <el-form ref="form" :model="account_config" label-width="140px">
                <el-row :gutter="20">
                  <el-col :span="24">
                    <el-form-item label="新智云邮箱:" required>
                      <el-input v-model="account_config.cloudMail"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row :gutter="20">
                  <el-col :span="24">
                    <el-form-item label="AccessKeyId:" required>
                      <el-input
                        v-model="account_config.cloudAccesskeyid"
                      ></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                  ...
                  <el-col :span="24">
                    <el-form-item label="SecretAccessKey:" required>
                      <el-input
                        type="textarea"
                        rows="3"
                        v-model="account_config.cloudSecretaccesskey"
                      ></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-form-item>
                  <el-button
                    type="primary"
                    icon="el-icon-check"
                    @click="SaveConfig('account')"
                    >保 存</el-button
                  >
                  <el-button
                    type="danger"
                    icon="el-icon-refresh"
                    @click="ResetConfig('account')"
                    >重 置</el-button
                  >
                </el-form-item>
              </el-form>
      ...
      >
        ...
        <el-form-item>
          <el-button
            type="primary"
            icon="el-icon-check"
            @click="UpdateK8sConfig()"
            >保 存</el-button
          >
          <el-button
            type="danger"
            icon="el-icon-refresh"
            @click="ResetConfig('K8sConfig')"
            >重 置</el-button
          >
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="忽略namespace" :visible.sync="namespaceDialogFormVisible">
      ...
      <div style="margin-top: 15px; text-align: center">
        ...
        <el-button size="medium" type="info" @click="closeNamespace"
          >取 消</el-button
        >
      </div>
    </el-dialog>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer" style="margin-top: 15px">
        <el-button size="medium" type="primary" @click="closeCreateNameSpace"
          >取 消</el-button
        >
    ...
    >
      ...
      <div style="margin-top: 15px; text-align: center">
        ...
        <el-button size="medium" type="info" @click="closeFormVistType"
          >取 消</el-button
        >
      </div>
    </el-dialog>
