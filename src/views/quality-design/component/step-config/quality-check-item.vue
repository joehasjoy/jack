    ...
    <el-drawer :visible.sync="show" direction="rtl" :with-header="false" :modal="false" size="20%">
        <el-card style="height:100%;overflow: auto;">
            <div slot="header" class="list-card-header">
                ...
                <span style="margin-left: 5px">指定卡控环境</span>
            ...
            <el-form ref="form" :model="form" label-position="top" label-width="80px">
                <el-form-item label="卡控环境" :rules="[{ required: true, message: '必选项不能为空', trigger: 'change' }]">
                    <el-select v-model="form.params.env" placeholder="请选择指定的卡控环境" style="width:100% ;" clearable>
