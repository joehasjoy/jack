    ...
    <el-drawer :visible.sync="show" direction="rtl" :with-header="false" :modal="false" size="20%">
        <el-card style="height:100%;overflow: auto;">
            <div slot="header" class="list-card-header">
                ...
                <span style="margin-left: 5px">指定发布构建分支</span> &nbsp;
            ...
            <el-form ref="form" :model="form" label-position="top" label-width="80px">
                <el-form-item label="发布分支" :rules="[{ required: true, message: '必选项不能为空', trigger: 'change' }]">
                    <el-select v-model="form.params.branch" placeholder="请选择指定的发布分支" style="width:100% ;" clearable>
                        <el-option v-for="(item, index) in branchOptions" :key="index" :label="item"
...
export default {
    ...
    data() {
        return {
            show: false,
            branchOptions: ["release-test", "release-prod", "master"],
