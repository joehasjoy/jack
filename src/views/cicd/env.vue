    ...
    <div style="padding: 10px 10px 0 10px">
      <el-card style="margin: 10px">
        <el-card style="margin: 5px 0">
          ...
          <el-form :inline="true" :model="formSearch" class="demo-form-inline">
            <el-form-item label="环境名"><el-input v-model="formSearch.name" placeholder="环境名"></el-input></el-form-item>
            <el-form-item>
              <el-button type="primary" @click="GetTableList">查询</el-button>
              <el-button type="primary" @click="dialognewRowForm = true; newTitle='新建'; newRow.id=''">新增</el-button>

            </el-form-item>
            <el-button style="float: right" @click="InitGetTableData(url, limit, page)">刷新</el-button>
          </el-form>
      ...
      <el-dialog :title="newTitle" :visible.sync="dialognewRowForm" top="30px" :close-on-click-modal="false" width="500px">
        <el-form size="mini" label-width="120px" :rules="newRules" :model="newRow" ref="newRow">
          ...
          <el-form-item label="环境名" prop="name" :rules="[{required:true,message:'请输入权限名.', trigger: 'blur'}]">
            <el-input autocomplete="off" v-model="newRow.name" style="width: 240px"></el-input>
          </el-form-item>
          <el-form-item label="描述" prop="description" :rules="[{required:true,message:'请输入权限名.', trigger: 'blur'}]">
            <el-input autocomplete="off" v-model="newRow.description" style="width: 240px"></el-input>
          </el-form-item>
    ...
    data() {
      return {
        ...
        tableKey: [
          ...
          { name: '启用', value: 'is_enable', ShowOverflowTooltip: false, formatter: function(row, column, cellValue, index) {
