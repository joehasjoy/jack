<template>
    <div style="margin: 10px">
      ...
      <el-table border id="out-table"
        ...
        <el-table-column sortable label="IP" prop="ip"></el-table-column>
        <el-table-column sortable label="cpu最小使用率" prop="cpu_min"></el-table-column>
        <el-table-column sortable label="cpu最大使用率" prop="cpu_max"></el-table-column>
        <el-table-column sortable label="cpu平均使用率" prop="cpu_avg"></el-table-column>
        <el-table-column sortable label="内存最小GB" prop="ram_min"></el-table-column>
        <el-table-column  sortable label="内存最大GB" prop="ram_max"></el-table-column>
        <el-table-column sortable label="内存平均GB" prop="ram_avg"></el-table-column>
        <el-table-column sortable label="内存平均使用率" prop="ram_avg_percent"></el-table-column>
        <el-table-column sortable label="内存总计GB" prop="ram_total"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      InitGetTableData: function(url,page_size, page_index, conn) {
        ...
        this.axios.defaults.timeout =  600000;
        this.axios({
          method: 'POST',
          url: url,
